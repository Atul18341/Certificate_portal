                ...
                <tr key={`${student.id}-${idx}`} className="hover:bg-slate-50/60">
                  ...
                  <td className="p-4 text-right px-6">
                    <button
                      ...
                      className="px-3 py-1.5 bg-slate-100 border border-slate-200 font-bold rounded-lg text-slate-600 hover:text-indigo-600 flex items-center gap-1 ml-auto cursor-pointer transition"
                    >
